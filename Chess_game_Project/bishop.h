...
class bishop : public piece_class
{
public:
	bishop(int a, int b, int color_val) : piece_class(a, b, color_val) {}
	...
	block_address* find_all_movements(board_class& board, int& count)override
	{
